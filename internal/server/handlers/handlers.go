...
func RegisterUserHandlers(mux *chi.Mux, userStore users.Store, auth *jwtauth.JWTAuth) {
...
func RegisterOrdersHandlers(mux *chi.Mux, ordersStore orders.Store, auth *jwtauth.JWTAuth) {
	mux.Group(func(r chi.Router) {
